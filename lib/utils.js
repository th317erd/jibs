...
export const iterate = _iterate;

export function childrenDiffer(children1, children2) {
  if (children1 === children2)
    return false;

  let result1 = (!Array.isArray(children1)) ? deadbeef(children1) : deadbeef(...children1);
  let result2 = (!Array.isArray(children2)) ? deadbeef(children2) : deadbeef(...children2);
